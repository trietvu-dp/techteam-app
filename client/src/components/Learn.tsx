...
export function Learn() {
    ...
    const {data: rankingsData = [], isLoading: rankingsLoading, error: rankingsError} = useQuery<Array<User & {
        rank: number
    }>>({
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="mt-2">
                                                    ...
                                                    <p className="text-xs text-slate-600 mt-1">{challenge.progress}%
                                                        complete</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <Card key={rec.id} className="p-3">
                                    ...
                                    >
                                        <div className="flex items-start gap-3 flex-1">
                                            <div
                                                className={`p-2 rounded-lg ${rec.contentType === 'video' ? 'bg-red-50' : 'bg-blue-50'}`}>
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    ...
                                                    <Badge variant="secondary"
                                                           className="text-xs">{rec.contentType}</Badge>
                                                </div>
                                                {rec.duration &&
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {user.isCurrentUser && (
                                                            <Badge
                                                                className="bg-blue-600 text-white text-xs">You</Badge>
                                                        )}
                                                    </div>
                ...
                <TabsContent value="resources" className="space-y-4 mt-4">
                    ...
                    <div className="space-y-2">
                        <h3 className="mb-3">
                            ...
                            <span
                                className="text-sm text-slate-500 font-normal ml-2">({filteredResources.length})</span>
                        </h3>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <Badge variant="secondary"
                                                       className="text-xs">{resource.category}</Badge>
                                                <Badge
                                                    className="text-xs bg-slate-100 text-slate-600">{resource.contentType}</Badge>
                                            </div>
                    ...
                    <Card className="p-4 border-2 border-dashed border-blue-300 bg-blue-50">
                        ...
                        <p className="text-sm text-slate-600 mb-3">
                            Resources are organized with "Try Now" scenarios and required materials boxes to support
                            hands-on learning
                        </p>
